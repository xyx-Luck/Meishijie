  ...
  <section class="detail-content">
    <div class="detail-materials">
      ...
      <div class="detail-materials-box clearfix">
        <h3>主料</h3>
        <ul>
          <li class="" v-for="(main,index) in info.raw_material.main_material" :key="index">
            {{main.name}}
            <span>{{main.specs}}</span>
          </li>
        </ul>
      </div>
      <div class="detail-materials-box clearfix">
        <h3>辅料</h3>
        <ul>
          <li class="" v-for="(val,index) in  info.raw_material.accessories_material" :key="index"> 
            {{val.name}}
            <span>{{val.specs}}</span>
          </li>
        </ul>
    ...
    <div class="detail-explain">
      <h2>菜的做法</h2>
      <section class="detail-section clearfix" v-for="(step,index) in info.steps" :key="index">
